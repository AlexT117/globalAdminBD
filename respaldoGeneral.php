...
<body>
	...
	<div class="container">
		...
		<?php 
				 ...
				 */
/*EDITAR*/		define("DB_USER", 'root');
				define("DB_PASSWORD", '12345678');
				define("DB_NAME", 'agencia');
				define("DB_HOST", 'localhost');
/*FIN EDITAR*/	define("BACKUP_DIR", 'Backup'); // Comment this line to use same script's directory ('.')
...
/*EDICIÓN OPCIONAL*/    $this->backupFile              = 'respaldo_agencia.sql';
				...
				if (php_sapi_name() != "cli") {
				    echo '<div style="font-family: monospace; color:black;">';
				}
				...
				?>
		<hr>
<!--------FINAL, DAR FORMATO PARA PRESENTAR--------------!-->
        <h1>Respaldo correcto</h1>
		<hr>
